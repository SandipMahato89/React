...
function App() {
  ...
  const currencyInfo = useCurrencyInfo(from); // calling useCurrencyInfo based on from value and currencyInfo will contain the data i.e returned from useCurrencyInfo
